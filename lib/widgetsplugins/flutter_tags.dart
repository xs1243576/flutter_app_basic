...
//void main() => runApp(flutter_tagsApp());

class flutter_tagsApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: flutter_tagsHomePage(title: 'Flutter Tags'),
    );
  }
}

class flutter_tagsHomePage extends StatefulWidget {
  flutter_tagsHomePage({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _flutter_tagsHomePageState createState() => _flutter_tagsHomePageState();
}

class _flutter_tagsHomePageState extends State<flutter_tagsHomePage>
