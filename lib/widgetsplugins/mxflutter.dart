...
class mxflutterApp extends StatelessWidget {
          ...
          children: <Widget>[
            ListTile(
              ...
              onTap: () {
                ...
                //MXJSPageWidget的参数 jsWidgetName: "MXJSWidgetHomePage",在mxflutter_js_src/main.js  mxflutterApp::createJSWidgetWithName 函数中使用，
                //创建你需要的MX JS Widget
                Navigator.push(
                    context,
                    MaterialPageRoute(
