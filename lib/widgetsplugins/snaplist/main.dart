import 'horizontal_explicit.dart';
import 'horziontal.dart';
import 'vertical.dart';
import 'package:flutter/material.dart';

//void main() => runApp(new snaplistApp());
...
class snaplistApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new snaplistHomePage(),
    );
  }
}

class snaplistHomePage extends StatefulWidget {
  @override
  _snaplistHomePageState createState() => new _snaplistHomePageState();
}

class _snaplistHomePageState extends State<snaplistHomePage> {
  List<String> urls = [
