...
class FlutterPlatformWidgetsMain extends StatelessWidget {
  // This widget is the root of your application.
  @override
  Widget build(BuildContext context) => FlutterPlatformWidgetsApp();
}

class FlutterPlatformWidgetsApp extends StatefulWidget {
  @override
  _FlutterPlatformWidgetsAppState createState() => _FlutterPlatformWidgetsAppState();
}

class _FlutterPlatformWidgetsAppState extends State<FlutterPlatformWidgetsApp> {
