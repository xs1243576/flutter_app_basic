...
class DropdownMenuApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new DropdownMenuPage(title: 'Flutter Demo Home Page'),
    );
  }
}

class DropdownMenuPage extends StatefulWidget {
  DropdownMenuPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _DropdownMenuPageState createState() => new _DropdownMenuPageState();
}
