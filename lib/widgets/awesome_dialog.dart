...
class AwesomeDialogApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Fancy Dialog Example',
//      initialRoute: '/',
      home: new AwesomeDialogAppPage(),
//      onGenerateRoute: RouteGenerator.generateRoute,
    );
  }
}

class AwesomeDialogAppPage extends StatefulWidget {
  const AwesomeDialogAppPage({
    Key key,
  }) : super(key: key);

  @override
  _AwesomeDialogAppPageState createState() => _AwesomeDialogAppPageState();
}

class _AwesomeDialogAppPageState extends State<AwesomeDialogAppPage> {
//  AwesomeDialog _awesomeDialog = AwesomeDialog(
//    context: null,
...
//  AwesomeDialog _awesomeDialog = null;
