...
import 'flutter_swiper/src/ExampleCustom.dart';
import 'flutter_swiper/src/config.dart';
import 'flutter_swiper/src/ExampleSwiperInScrollView.dart';

import 'package:flutter/cupertino.dart';

//void main() => runApp(new MyApp());

class FlutterSwiperApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new FlutterSwiperPage(title: 'Flutter Swiper'),
      //home: buildHome(),
      routes: {
...
class FlutterSwiperPage extends StatefulWidget {
  FlutterSwiperPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _FlutterSwiperPageState createState() => new _FlutterSwiperPageState();
}
