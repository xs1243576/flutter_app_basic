import 'example/text_style.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';

//void main() => runApp(MyApp());

class FlutterScreenutilApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: FlutterScreenutilPage(),
    );
  }
}

class FlutterScreenutilPage extends StatefulWidget {
  FlutterScreenutilPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _FlutterScreenutilPageState createState() => _FlutterScreenutilPageState();
}
