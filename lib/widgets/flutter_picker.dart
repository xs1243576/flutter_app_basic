...
//一个日期，时间，日期时间，icon，自定义数据的选择器，可以居中弹窗，也可以在底部弹出。（目前来看是最全面的一个选择器控件。该插件支持ios和android平台，使用的是ios的风格的UI效果。）

class FlutterPickerApp extends StatefulWidget {
  @override
  _FlutterPickerAppState createState() => new _FlutterPickerAppState();
}

class _FlutterPickerAppState extends State<FlutterPickerApp> {
  @override
