...
class FlutterDownloaderApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      home: new FlutterDownloaderPage(
        title: 'Downloader',
        platform: platform,
      ),
    );
...
class FlutterDownloaderPage extends StatefulWidget with WidgetsBindingObserver {
  final TargetPlatform platform;

  FlutterDownloaderPage({Key key, this.title, this.platform}) : super(key: key);

  final String title;

  @override
  _FlutterDownloaderPageState createState() => new _FlutterDownloaderPageState();
}
