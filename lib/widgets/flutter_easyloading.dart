  ...
  Widget build(BuildContext context) {
    return FlutterEasyLoading(
      child: MaterialApp(
        ...
        home: FlutterEasyloadingHomePage(title: 'Flutter EasyLoading'),
      ),
    );
  }
}

class FlutterEasyloadingHomePage extends StatefulWidget {
  FlutterEasyloadingHomePage({Key key, this.title}) : super(key: key);
...
class _FlutterEasyloadingPageState extends State<FlutterEasyloadingHomePage> {
  Timer _timer;
  double _progress;
