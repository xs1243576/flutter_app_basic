...
class FlutterStatusbarManagerApp extends StatefulWidget {
  FlutterStatusbarManagerApp();

  factory FlutterStatusbarManagerApp.forDesignTime() {
    // TODO: add arguments
    return new FlutterStatusbarManagerApp();
  }

  @override
  _FlutterStatusbarManagerAppState createState() =>
      new _FlutterStatusbarManagerAppState();
}

class _FlutterStatusbarManagerAppState
    extends State<FlutterStatusbarManagerApp> {
