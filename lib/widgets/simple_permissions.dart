...
class SimplePermissionsApp extends StatefulWidget {
  @override
  _SimplePermissionsState createState() => new _SimplePermissionsState();
}

class _SimplePermissionsState extends State<SimplePermissionsApp> {
