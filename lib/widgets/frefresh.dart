...
class FrefreshApp extends StatefulWidget {
  @override
  _FrefreshAppState createState() => _FrefreshAppState();
}

class _FrefreshAppState extends State<FrefreshApp> {
  ...
  String image2 = "assets/loading.gif";
