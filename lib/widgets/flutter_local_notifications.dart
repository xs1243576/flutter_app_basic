...
import 'package:com.example.flutterappbasic/common/Constant.dart';
...
class _NotifyPageState extends State<NotifyPage> {
  ...
  void initState() {
    ...
    notificationAppLaunchDetails = Constant.notificationAppLaunchDetails;
  }
            ...
            CupertinoDialogAction(
              ...
              onPressed: () async {
                ...
                await Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        SecondScreenNotify(receivedNotification.payload),
                  ),
                );
              },
            )
  ...
  void _configureSelectNotificationSubject() {
    selectNotificationSubject.stream.listen((String payload) async {
      await Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => SecondScreenNotify(payload)),
      );
    });
  }
...
class SecondScreenNotify extends StatefulWidget {
  SecondScreenNotify(this.payload);

  final String payload;

  @override
  State<StatefulWidget> createState() => SecondScreenNotifyState();
}

class SecondScreenNotifyState extends State<SecondScreenNotify> {
  String _payload;
