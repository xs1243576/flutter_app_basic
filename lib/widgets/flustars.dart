...
class FlustarsApp extends StatefulWidget {
  @override
  _FlustarsAppState createState() => _FlustarsAppState();
}

class _FlustarsAppState extends State<FlustarsApp> {
  @override
  void initState() {
    super.initState();
    _initAsync();
...
//                  CupertinoPageRoute<void>(builder: (ctx) => SecondPageFlustars()));
            },
          ),
        ],
      ),
...
class SecondPageFlustars extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return SecondPageFlustarsState();
  }
}

class SecondPageFlustarsState extends State<SecondPageFlustars> {
  @override
  void initState() {
    super.initState();
    _init();
//    _initWithCtx();
  ...
  void _init() {
    ...
    LogUtil.e("SecondPageFlustars _init screenWidth: $screenWidth, screenHeight: $screenHeight, screenDensity: $screenDensity" +
  ...
  void _initWithCtx() {
    ...
    LogUtil.e("SecondPageFlustars _initWithCtx screenWidth: $screenWidth, screenHeight: $screenHeight, screenDensity: $screenDensity" +
  ...
  Widget build(BuildContext context) {
    ...
    double height = ScreenUtil.getInstance().screenHeight;
    LogUtil.e(
        "SecondPageFlustars statusBar: $statusBar, width: $width, height: $height");
