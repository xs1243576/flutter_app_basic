...
class NeeKoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: NeeKoPage(title: 'Neeko Demo'),
    );
  }
}

class NeeKoPage extends StatefulWidget {
  NeeKoPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _NeeKoPageState createState() => _NeeKoPageState();
}

class _NeeKoPageState extends State<NeeKoPage> {
