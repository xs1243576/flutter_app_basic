...
class FlutterMMkvApp extends StatefulWidget {
  @override
  _FlutterMMkvAppState createState() => new _FlutterMMkvAppState();
}

class _FlutterMMkvAppState extends State<FlutterMMkvApp> {
                    ...
                    RaisedButton(
                      onPressed: () {
                        FlutterMmkv.encodeString(
                            "mystring", myController.text.toString());
