...
import 'sliding_sheet/custom_container.dart';
...
class SlidingSheetApp extends StatefulWidget {
  @override
  _SlidingSheetAppState createState() => _SlidingSheetAppState();
}

class _SlidingSheetAppState extends State<SlidingSheetApp> {
