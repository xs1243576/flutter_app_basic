...
class OkImageApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: OkImagePage(title: 'Flutter Demo Home Page'),
    );
  }
}

class OkImagePage extends StatefulWidget {
  OkImagePage({Key key, this.title}) : super(key: key);
  ...
  @override
  _OkImagePageState createState() => _OkImagePageState();
}

class _OkImagePageState extends State<OkImagePage> {
  int _counter = 0;
