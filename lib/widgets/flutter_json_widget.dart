...
class FlutterJsonWidgetApp extends StatelessWidget {
...
// is not restarted.
      ...
      home: FlutterJsonWidgetPage(title: 'Json Viewer Example'),
    );
  }
}

class FlutterJsonWidgetPage extends StatefulWidget {
  FlutterJsonWidgetPage({Key key, this.title}) : super(key: key);
...
// always marked "final".
  ...
  @override
  _FlutterJsonWidgetPageState createState() => _FlutterJsonWidgetPageState();
}

class _FlutterJsonWidgetPageState extends State<FlutterJsonWidgetPage> {
