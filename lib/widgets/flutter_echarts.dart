...
class FlutterEchartsApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: FlutterEchartsPage(),
    );
  }
}

class FlutterEchartsPage extends StatefulWidget {
  FlutterEchartsPage({Key key}) : super(key: key);

  @override
  _FlutterEchartsPageState createState() => _FlutterEchartsPageState();
}

class _FlutterEchartsPageState extends State<FlutterEchartsPage> {
