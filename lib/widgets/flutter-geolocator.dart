...
import 'flutter-geolocator/pages/lookup_address_widget.dart';
import 'flutter-geolocator/pages/calculate_distance_widget.dart';
import 'flutter-geolocator/pages/current_location_widget.dart';
import 'flutter-geolocator/pages/location_stream_widget.dart';
...
class GeolocatorExampleApp extends StatefulWidget {
  @override
  State<GeolocatorExampleApp> createState() => _BottomNavigationState();
}

class _BottomNavigationState extends State<GeolocatorExampleApp> {
