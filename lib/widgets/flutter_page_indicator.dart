...
class FlutterPageIndicatorApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new FlutterPageIndicatorPage(title: 'Flutter Demo Home Page'),
    );
  }
}

class FlutterPageIndicatorPage extends StatefulWidget {
  FlutterPageIndicatorPage({Key key, this.title}) : super(key: key);
  ...
  @override
  _FlutterPageIndicatorPageState createState() => new _FlutterPageIndicatorPageState();
}
...
class _FlutterPageIndicatorPageState extends State<FlutterPageIndicatorPage> {
  int _index = 1;
  ...
  @override
  void didUpdateWidget(FlutterPageIndicatorPage oldWidget) {
