...
class FlutterCacheManagerApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Cache Manager Demo',
      home: FlutterCacheManagerPage(),
    );
  }
}
...
class FlutterCacheManagerPage extends StatefulWidget {
  @override
  _FlutterCacheManagerPageState createState() => _FlutterCacheManagerPageState();
}
