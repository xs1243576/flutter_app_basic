...
class MMkvFlutterApp extends StatefulWidget {
  @override
  _MMkvFlutterAppState createState() => new _MMkvFlutterAppState();
}

class _MMkvFlutterAppState extends State<MMkvFlutterApp> {
