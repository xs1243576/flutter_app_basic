...
class FlutterHtmlApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new FlutterHtmlPage(title: 'flutter_html Example'),
    );
  }
}

class FlutterHtmlPage extends StatefulWidget {
  FlutterHtmlPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _FlutterHtmlPageState createState() => new _FlutterHtmlPageState();
}
...
class _FlutterHtmlPageState extends State<FlutterHtmlPage> {
  @override
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(
