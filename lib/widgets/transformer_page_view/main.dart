...
class TransformerPageViewApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new TransformerPageViewPage(title: 'Flutter Demo Home Page'),
    );
  }
}

class TransformerPageViewPage extends StatefulWidget {
  TransformerPageViewPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _TransformerPageViewPageState createState() => new _TransformerPageViewPageState();
}

class _TransformerPageViewPageState extends State<TransformerPageViewPage> {
